...
public class ColliderTriggerEvent : MonoBehaviour
{
    ...
    [SerializeField] UnityEvent<Collider2D> evenTriggerCollider;

    public UnityEvent<Collider2D> EvenTriggerCollider { get => evenTriggerCollider; set => evenTriggerCollider = value; }
    public UnityEvent EventTrigger { get => eventTrigger; set => eventTrigger = value; }
    ...
    {
        eventTrigger?.Invoke();
        evenTriggerCollider?.Invoke(collision);
