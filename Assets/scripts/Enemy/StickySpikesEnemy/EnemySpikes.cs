...
public class EnemySpikes : MonoBehaviour,IStickable
{
    ...
    private void Start()
    {
        ...
        baseEnemy = transform.parent.gameObject;
    ...
    public void stickObject(GameObject collision)
    {
        ...
        baseEnemy.GetComponent<IEnemy>().dealDamage(collision);
        baseEnemy.GetComponent<SpriteRenderer>().color = Color.red; // ----> enemy anim
    ...
    public void deStickObject()
    {
        ...
        if(sticked != null)
        {
            ...
            baseEnemy.GetComponent<SpriteRenderer>().color = Color.white; // ----> enemy anim
